     ...
     className='right md:w-[50%] flex items-center justify-center flex-col gap-2 h-full'>
      <div className='w-3/4'>
        <form action="" className='h-full w-full'>
          <h1 className='text-3xl text-center mb-10 text-blue-400 text-shadow-[2px_2px_5px_black] font-extrabold'>Welcome back</h1>
          <div className='flex flex-col gap-4'>
            ...
            <button className='bg-blue-500 text-white rounded-md p-2 shadow-[3px_3px_10px_rgba(0,0,0,1)] 'onClick={(e)=>{handleLogin(e)}}>Log In</button>
          </div>
        </form>
      </div>
      <div>
        ...
        <div className='flex items-center justify-center gap-4'>
          ...
          <h1>Don't have an account?<span className='hover:cursor-pointer text-blue-400'onClick={()=>{navigate("/signup")}}>Signup</span></h1>
        </div>
    </motion.div>
